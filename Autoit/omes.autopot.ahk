...
menu_open:
	...
	if (potion = 1)
	{
		hpvalue := % sliderhp.pos * 1.66 + 225
		mpvalue := % slidermp.pos * 1.66 + 331

		PixelSearch,,, 200, 726, %hpvalue%, 732, 0xBEBEBE, 2, Fast RGB
		...
		PixelSearch,,, 336, 726, %mpvalue%, 732, 0xCCCCCC, 2, Fast RGB
